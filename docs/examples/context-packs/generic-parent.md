...
Role: parent
Phase: phase_001
Budget: 3099/12000 estimated tokens (within_budget)

## Objective

Coordinate the current Meta Harness phase with bounded context, evidence-backed proof, and checkpoint discipline.
...
### docs/agent-support-matrix.md (lines 1-50)
